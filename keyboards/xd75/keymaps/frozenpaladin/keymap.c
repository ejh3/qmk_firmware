...
#define OS_LSFT OSM(MOD_LSFT) //temporarily removed to test hr shift
#define OS_LGUI OSM(MOD_LGUI)

#define T_SHFT  SFT_T(KC_T)
#define N_SHFT  SFT_T(KC_N)
#define S_CTL CTL_T(KC_S)
#define E_CTL CTL_T(KC_E)


#define MNS_ALT ALT_T(KC_MINS)
...
#define S_CTRL CTL_T(KC_DEL)
#define E_CTRL CTL_T(KC_DEL)
...
/*  [_FN] = LAYOUT_ortho_5x15(
    ...
    [_CMK] = LAYOUT_ortho_5x15(
        ...
        KC_CAPS, KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_F11,  XXXXXXX, KC_F12,  KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, OS_LGUI,
        KC_BSPC, KC_A,    KC_R,    S_CTL,   T_SHFT,  KC_G,    G(KC_V), XXXXXXX, XXXXXXX, KC_M,    N_SHFT,  E_CTL,    KC_I,    KC_O,    KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    XXXXXXX, XXXXXXX, XXXXXXX, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX,
        MO(_SYM),XXXXXXX, XXXXXXX, MNS_ALT, SPC_SYM, ENT_CTL, XXXXXXX, XXXXXXX, XXXXXXX, ESC_CTL, TAB_NAV, DEL_ALT, XXXXXXX, XXXXXXX, MO(_SYM)
    ),
/*  [_QWE] = LAYOUT_ortho_5x15(
     ...
     * | XXXXXX | F1     | F2     | F3     | F4     | F5     | XXXXXX | XXXXXX | XXXXXX | F8     | F9     | F10    | F11    | F12    | XXXXXX |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * | `      | +      | 5      | 4      | 9      | B      | F6     | XXXXXX | F7     | J      | L      | U      | Y      | '      | RGUI   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * | BACKSP | *      | 3      | 2      | 1      | G      | XXXXXX | XXXXXX | XXXXXX | M      | N      | E      | I      | O      | ENTER  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
     * | LSHIFT | -      | 7      | 6      | 8      | V      | XXXXXX | XXXXXX | XXXXXX | K      | H      | ,      | .      | /      |        |
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | SPACE  | XXXXXX | XXXXXX | ESC    | CTRL   | TAB    | ALT    | XXXXXX | RSHIFT | SYM    | SPACE  | NAV    | XXXXXX | XXXXXX | NUM    |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_NUM] = LAYOUT_ortho_5x15(
        ...
        KC_DLR,  KC_PLUS, KC_5,    KC_4,    KC_9,    KC_SLSH, _______, XXXXXXX, _______, KC_RCBR, KC_LCBR, KC_PIPE, _______, _______, _______,
        _______, KC_ASTR, KC_3,    KC_2,    KC_1,    KC_DOT,  _______, XXXXXXX, _______, KC_RPRN, KC_LPRN, KC_AMPR, KC_BSLS, KC_AT,   _______,
        KC_PERC, KC_EQL,  KC_7,    KC_6,    KC_8,    KC_CIRC, XXXXXXX, XXXXXXX, XXXXXXX, KC_RBRC, KC_LBRC, _______, _______, _______, _______,
        _______, _______, _______, _______, KC_0,    _______, _______, XXXXXXX, _______, _______, _______, _______, _______, _______, _______
    ),
    ...
    [_SYM] = LAYOUT_ortho_5x15(
        _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, 
        _______, KC_PLUS, KC_AT,   KC_EXLM, KC_EQL,  KC_TILD, _______, XXXXXXX, _______, KC_RCBR, KC_LCBR, KC_PIPE, KC_AMPR, _______, _______,
        _______, KC_ASTR, KC_HASH, KC_DLR,  KC_PERC, KC_GRV,  _______, XXXXXXX, _______, KC_RPRN, KC_LPRN, KC_EQL,  KC_EXLM, KC_BSLS, _______,
        _______, _______, _______, KC_AT,   KC_EXLM, KC_CIRC, XXXXXXX, XXXXXXX, XXXXXXX, KC_RBRC, KC_LBRC, _______, _______, _______, _______,
    ...
    [_NAV] = LAYOUT_ortho_5x15(
        XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX, RESET,   XXXXXXX, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  XXXXXXX,
        _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, NK_TOGG, KC_CAPS, _______, _______, _______, 
        _______, _______, _______, KC_PSCR, _______, _______, _______, XXXXXXX, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, _______, _______,
        _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, G(KC_V), _______, XXXXXXX, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_HOME, KC_END,  _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, XXXXXXX, _______, _______, _______, _______, _______, _______, _______
    )
